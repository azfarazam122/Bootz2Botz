            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="wholebody">
                        ...
                        <div class="hero-sec"
                            style="background: url(images/kado.jpg); position: relative; background-size: cover; background-repeat: no-repeat; height: 90vh;">
                        ...
                        <div class="blackline">
                            <div class="hero-text">
                                <h1 style="font-size: 3.7rem;">Welcome to 
                                    - <span style="color: #f79c51"> Kado Bank
                                    </span></h1>
                        ...
                        <div class="container mt-5">
                            ...
                            <div id="movieNightMainDiv">
                                        ...
                                        <div class="row my-4">
                                            <div class="col-lg-12 mt-3">
                                              ...
                                              <input type="text" placeholder="" class="form-control" name=""
                                                    style="width:100%;" id="kadobankinput">
                                ...
                                <div class="row col-md-6 ">
                                    ...
                                    <a style="text-decoration: none" target="blank" href="cash_station"
                                                    class="purpleButton">Go to CashStation Website</a>
                                    </div>
                                    <!-- /////////////////////// -->
                                </div>
                            </div>
